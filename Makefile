...
generate-admin:
	...
	$(PYTHON) $(VENV)/src/swaggerreactadmingenerator/swagger_react_admin_generator/generator.py swagger/management_layer.yml --output-dir=admin/generated --module-name="Girl Effect Management Portal" --permissions
