...
class Delete extends Component {
    ...
    render() {
        const { id, data, isLoading, resource, translate } = this.props;
        ...
        const defaultTitle = `Permanently ${translate('aor.page.delete', {
            name: `${resourceName}`,
            id,
            data
        })}`;
        const titleElement = data ? <Title record={data} defaultTitle={defaultTitle} /> : '';
            ...
            <div>
                <Card style={{ opacity: isLoading ? 0.8 : 1 }}>
                    ...
                    <form onSubmit={this.handleSubmit}>
                        <CardText>{`Are you sure? You cannot undo this action.`}</CardText>
